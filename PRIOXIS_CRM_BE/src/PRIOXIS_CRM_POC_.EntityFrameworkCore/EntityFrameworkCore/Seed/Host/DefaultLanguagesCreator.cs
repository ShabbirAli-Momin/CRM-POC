...
namespace PRIOXIS_CRM_POC_.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PRIOXIS_CRM_POC_Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(PRIOXIS_CRM_POC_DbContext context)
        {
            _context = context;
        }
