...
{
    public abstract class PRIOXIS_CRM_POC_WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PRIOXIS_CRM_POC_WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PRIOXIS_CRM_POC_WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PRIOXIS_CRM_POC_DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PRIOXIS_CRM_POC_DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PRIOXIS_CRM_POC_DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PRIOXIS_CRM_POC_DbContext, Task<T>> func)
        {
            T result;
